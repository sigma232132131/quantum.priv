...
function library:Watermark(text)
    ...
    bar.BackgroundColor3 = Color3.new(0.082353, 0.000000, 0.372549)
    ...
    function WatermarkFunctions:AddWatermark(text)
        ...
        bar.Name = "bar"
        bar.Parent = barFolder
        bar.BackgroundColor3 = Color3.new(0.054902, 0.000000, 0.294118)
        bar.BackgroundTransparency = 0
        bar.Size = UDim2.new(0, 0, 0, 1)
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        bar.Name = "bar"
        bar.Parent = barFolder
        bar.BackgroundColor3 = Color3.new(0.062745, 0.000000, 0.407843)
        bar.BackgroundTransparency = 0.200
        bar.Size = UDim2.new(0, 0, 0, 1)
        if type == "notification" then
            bar.BackgroundColor3 = Color3.new(0.105882, 0.000000, 0.352941)
        ...
        elseif type == "information" then
            bar.BackgroundColor3 = Color3.new(0.082353, 0.000000, 0.545098)
        end
...
function library:Introduction()
    ...
    edge.AnchorPoint = Vector2.new(0.5, 0.5)
    edge.BackgroundColor3 = Color3.new(0.082353, 0.070588, 0.121569)
    edge.BackgroundTransparency = 1
    ...
    bar.Name = "bar"
    bar.Parent = barFolder
    bar.BackgroundColor3 = Color3.new(0.086275, 0.000000, 0.458824)
    bar.BackgroundTransparency = 0.200
    bar.Size = UDim2.new(0, 0, 0, 1)
    ...
    xsxLogo.ImageColor3 = Color3.new(0.074510, 0.000000, 0.411765)
    ...
    hashLogo.ImageColor3 = Color3.new(0.125490, 0.000000, 0.580392)
    ...
    xsx.TextColor3 = Color3.new(0.121569, 0.121569, 0.121569)
    xsx.TextSize = 10.000
...
function library:Init(key)
    ...
    bar.Name = "bar"
    bar.Parent = barFolder
    bar.BackgroundColor3 = Color3.new(0.090196, 0.000000, 0.419608)
    bar.BackgroundTransparency = 0.200
    ...
    tabButtonsEdge.BackgroundColor3 = Color3.new(0.098039, 0.086275, 0.152941)
    ...
    containerEdge.BackgroundColor3 = Color3.new(0.086275, 0.074510, 0.133333)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.new(0.090196, 0.027451, 0.254902)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.new(0.086275, 0.015686, 0.278431)
        ...
        function Components:NewSection(text)
            ...
            rightBar.BackgroundColor3 = Color3.new(0.078431, 0.066667, 0.141176)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleEdge.BackgroundColor3 = Color3.new(0.070588, 0.047059, 0.133333)
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybind.BackgroundColor3 = Color3.new(0.094118, 0.070588, 0.200000)
        ...
        function Components:NewKeybind(text, default, callback)
            ...
            keybind.BackgroundColor3 = Color3.new(0.062745, 0.019608, 0.305882)
            keybind.Position = UDim2.new(0.780303001, 0, 0, 0)
            keybind.Size = UDim2.new(0, 87, 0, 22)
            keybind.AutoButtonColor = false
            keybind.Font = Enum.Font.SourceSans
