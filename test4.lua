...
function library:Watermark(text)
    ...
    edge.BackgroundColor3 = Color3.new(0.447059, 0.447059, 0.447059)
    ...
    background.BackgroundColor3 = Color3.new(0.388235, 0.388235, 0.388235)
    ...
    bar.BackgroundColor3 = Color3.new(46, 46, 46)
    ...
    function WatermarkFunctions:AddWatermark(text)
        ...
        edge.Parent = watermark
        edge.AnchorPoint = Vector2.new(0.5, 0.5)
        edge.BackgroundColor3 = Color3.fromRGB(0.101961, 0.101961, 0.141176)
        edge.Position = UDim2.new(0.5, 0, -0.03, 0)
        edge.Size = UDim2.new(0, 0, 0, 26)
