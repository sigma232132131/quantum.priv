...
function library:Watermark(text)
    ...
    backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(0.047059, 0.047059, 0.047059)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
    ...
    function WatermarkFunctions:AddWatermark(text)
        ...
        backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(0.031373, 0.031373, 0.031373)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
        backgroundGradient.Rotation = 90
        backgroundGradient.Name = "backgroundGradient"
        backgroundGradient.Parent = background
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(0.027451, 0.027451, 0.027451)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
        backgroundGradient.Rotation = 90
        backgroundGradient.Name = "backgroundGradient"
        backgroundGradient.Parent = background
...
function library:Init(key)
    ...
    backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(0.011765, 0.011765, 0.011765)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
    backgroundGradient.Rotation = 90
    backgroundGradient.Name = "backgroundGradient"
    backgroundGradient.Parent = background
    ...
    tabButtonsGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
    ...
    function TabLibrary:NewTab(title)
        ...
        function Components:NewButton(text, callback)
            ...
            buttonGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textboxTwoGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            selectorTwoGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderBackgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(6, 6, 6))}
