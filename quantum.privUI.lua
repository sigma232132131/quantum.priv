...
library.rank = "dev"
local Wm = library:Watermark("quantum.priv user | v" .. library.version ..  " | " .. library:GetUsername() .. " | rank: " .. library.rank)
...
for i = 20,0,-1 do 
    task.wait(0.08)
    local LoadingXSX = Notif:Notify("loading quantum.priv. . .", 3, "information") -- notification, alert, error, success, information
end 

library.title = "quantum.priv"
...
local Label1 = Tab1:NewLabel("camlock", "left")--"left", "center", "right"
...
local Keybind1 = Tab1:NewKeybind("Keybind 1", Enum.KeyCode.Insert, function(key)
...
local FinishedLoading = Notif:Notify("LOADED quantum.priv", 4, "success")
